...
public class MenuPPA extends JFrame {
	...
	public MenuPPA() {
		...
		panel_Praktikumsverwaltung.add(lblNewLabel_2);
		...
		lblNewLabel_4_1.setIcon(new ImageIcon(MenuPPA.class.getResource("/res/document_file_document_icon_159190.png")));
		lblNewLabel_4_1.setBounds(164, 96, 81, 61);
		panel_Praktikumsverwaltung.add(lblNewLabel_4_1);
		
		JLabel lblNewLabel_4_1_1 = new JLabel("");
		lblNewLabel_4_1_1.setIcon(new ImageIcon(MenuPPA.class.getResource("/res/document_file_document_icon_159190.png")));
		...
		lblNewLabel_4_1_1_1.setIcon(new ImageIcon(MenuPPA.class.getResource("/res/document_file_document_icon_159190.png")));
		...
		panel_Profil_2.setBounds(10, 36, 450, 212);
		...
		panel_Profil.add(lblNewLabel_3);
	}
}
